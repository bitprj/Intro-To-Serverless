...
Before we go any further, it's important to explain what a RESTful API is. Before we can even do *that*, we need to explain what an API is!

### What is an API, and what makes one "RESTful?"
...
###### **What does it mean to be "RESTful," though?**
