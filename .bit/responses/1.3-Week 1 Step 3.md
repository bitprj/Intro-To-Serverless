...
### ✅  Task:
- [ ] ***1:*** With Postman, send a GET request to the [Cataas API](https://cataas.com/#/)  and receive a cat picture with "Serverless" written on it 
- [ ] ***2:*** Comment the picture you receive from the API in this issue/pull request to move on.
...
### 1: The Cataas (Cats as a Service) API
