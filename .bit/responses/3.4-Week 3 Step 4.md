...
In the past few weeks and steps, you should've learned the basics of how to create an Azure Function and use the Giphy and Twilio APIs. For the rest of Week 3, we'll be looking into using [Azure Cosmos DB](https://azure.microsoft.com/en-us/services/cosmos-db/), a powerful NoSQL database.
