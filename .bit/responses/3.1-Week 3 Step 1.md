...
Challenge yourself to develop a new HTTP trigger function (no need to edit the code yet). Feel free to navigate to the previous issues/steps for guidance if you need extra help. Make sure to name the function `bunnimage-upload`.
