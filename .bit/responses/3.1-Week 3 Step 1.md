...
> ⚠️ **Warning:** The set-up for your blob storage container makes the endpoint **publicly accessible.** This means that it is *not* safe for real-world applications since it allows the potential for anyone with the endpint to access different blobs they should not have access to.
