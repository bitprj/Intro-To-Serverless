...
## [Parsing](https://oxylabs.io/blog/what-is-data-parser#:~:text=Data%20parsing%20is%20a%20method,be%20easily%20read%20and%20understood.) Data

We are building a Serverless Function to recieve a picture of someone and return if they have a beard or not. 

- [ ] create a new branch called `week2`
- [ ] commit your Azure Function code to a file named `week2/index.js`.
- [ ] Add your new Function url to a secret named FUNCTION_URL!
...
Once your azure function can successfully parse an image, you will be able to move on to the next step!
