...
We will be making a **POST request** to our Azure function with the image, which *will be sent in the body*. The first step is to get the image.
...
### Crafting the POST request to the Face API
...
#### It's time to ask the Face API to analyze our image. Use the [documentation](https://westus.dev.cognitive.microsoft.com/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236) to help!
...
### ⏬ Receiving Data
At this point, you should have an **async** function that makes a request to the Face API with the image.
<details>
