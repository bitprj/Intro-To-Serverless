...
- [ ] Test your function locally with Postman and, when you confirm that it works, deploy your function.
...
## 🚧 Test your Work
When you paste your **Function URL** from the Azure portal in your browser or make a GET request with **Postman** with a `password` parameter of "letmein", you should get a response of “Access granted.“. Otherwise, your function should output “Access denied.“.

:exclamation: Remember, you can test changes locally by pressing F5 or remotely after you deploy the function.
