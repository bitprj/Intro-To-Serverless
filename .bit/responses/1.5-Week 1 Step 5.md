...
<details>
<summary>Download VSCode and install some extentions!</summary>
...
<details>
<summary>What are those again?</summary>
Repositories (or repos) are essentially folders where you can store files of code. The repo of our camp was duplicated into your profile when you clicked "Create Template" so that you can commit changes and complete each lesson.
...
<details>
<summary>How can I use GitHub Desktop to commit my code?</summary>
...
<details>
<summary>How can I create a resource and deploy a simple HTTP trigger function with it?</summary>
