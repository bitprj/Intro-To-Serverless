...
### ✅  Task:
- [ ] ***1:*** Download Visual Studio Code and clone your repo using the Command line
- [ ] ***2:*** Run `git pull` locally to make sure you repo is updated and create a new branch named `week1`
- [ ] ***3:*** In a new file called `week1/helloworld.js`, write and export a JS function `hello` that returns "Hello World"
- [ ] ***4:*** Commit your changes to the `week1` branch move on
...
### 1-2: The IDE - Visual Studio Code
...
No worries, check [this out](../../GETTING_STARTED.md#x-the-step-failed-what-do-i-do) to help resolve the issue.
