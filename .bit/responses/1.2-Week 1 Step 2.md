...
<details>
<summary>What is an IDE and why do we need it?</summary>
...
<details>
<summary>OK, how do I install it?</summary>
...
**Task 2: Create a JavaScript file in a branch called `week1` that returns "`Hello World`".**
...
<details>
<summary>Can I have more detailed steps?</summary>
1. Create a new file
...
7. Create a new branch named `week1` and commit your `helloworld.js` file in the root directory.</details>

**7. Make sure you export the function, and commit `helloworld.js` to the root directory of a new branch `week1` in this repository to move on!**
