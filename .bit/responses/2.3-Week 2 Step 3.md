...
- [ ] Edit your function to make a request to the Face API and send back the emotion data in the body in **JSON format** ```body: {the_data}```

🚀 Place your function URL in a [repository secret](https://docs.github.com/en/actions/reference/encrypted-secrets#creating-encrypted-secrets-for-a-repository) called `EMOTIONAL_FUNCTION` and commit your code to `Getting-Emotional/index.js`
