...
- [ ] Parse an image from an HTTP request using `parse-multipart`
- [ ] Return the image encoded in base64 in the body
...
Before you can install `parse-multipart`, you need to enter `npm init -y` into the console. This command allows us to set up a new npm package:
