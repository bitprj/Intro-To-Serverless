...
- [ ]  Create a new branch called `deepsecrets`
- [ ]  Set up a Twilio Account
- [ ]  Create an Azure Function and add its URL to a repository secret named `DEEPSECRETS_ENDPOINT`
...
- [ ]  Commit your function code to `deepsecrets/index.js` on the `deepsecrets` branch
