...
- [ ] place your function URL in a [repository secret](https://docs.github.com/en/actions/reference/encrypted-secrets#creating-encrypted-secrets-for-a-repository) called `TWO_CATZ`
- [ ] commit function code in a file named `TwoCatz/twocatz.js` to the `week1` branch
