...
name: Week 1 Step 6
---
Week 1 Step 6 ⬤⬤⬤⬤⬤⬤◯◯ | 🕐 Estimated completion: 15-25 minutes
...
**Help us by creating an Code an HTTP trigger function with `morse-code-converter` npm packages that takes in English as a parameter and outputs it in Morse Code.**. 

### ✅  Task:

- [ ]  run `git pull` 
- [ ]  make sure you are in the `week1` branch 
- [ ]  install the `morse-code-converter` npm package
- [ ]  create and deploy an HTTP trigger Azure Function that takes in English as a parameter and outputs it in Morse Code. 
- [ ] place your function URL in a [repository secret](https://docs.github.com/en/actions/reference/encrypted-secrets#creating-encrypted-secrets-for-a-repository) called `MORSE_URL`
- [ ] commit function code in a file named `week1/morse.js` to the `week1` branch

### 🚧 Test your Work
<-- add how to test add example input/output-->

### Installing NPM packages with Azure Functions
...
<details>
<summary>How to install NPM Packages in Azure Functions</summary>
...
### Writing the Morse Code Function
...
<- summarize the steps you need to take to write the morse code function ->
<details>
