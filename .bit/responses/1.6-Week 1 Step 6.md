...
- [ ] ***1:*** Run `git pull` and make sure you are in the `week1` branch 
- [ ] ***2:*** Create and deploy an HTTP trigger Azure Function that creates a request for an image from the CATAAS API
- [ ] ***3:*** Return the image in the request body **encoded in base64**
- [ ] ***4:*** Place your function URL in a [repository secret](https://docs.github.com/en/actions/reference/encrypted-secrets#creating-encrypted-secrets-for-a-repository) called `TWOCATZ_ENDPOINT`
- [ ] ***5:*** Commit function code in a file named `TwoCatz/index.js` to the `week1` branch

*Note: Every time you make a new commit to `week1`, we will check your function by making a request.*

### 2: Making requests in Azure
...
### 3: Return your images encoded in base64!
