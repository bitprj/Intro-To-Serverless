...
Similarly, serverless functions are cool since they engage the use of 
...
1. First start by creating a variable that get the data (try googling "how to get current time in Javascript").
