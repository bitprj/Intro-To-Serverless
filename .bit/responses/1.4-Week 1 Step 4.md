...
```
<details>
    <summary> How to use Postman to test. </summary>
    </br>
    <img src="https://user-images.githubusercontent.com/69332964/113361613-63ef6c00-931a-11eb-9380-7d58a3dea1b4.png" width=600px/>
</details>
...
## Return the Current Time + Setting up Local Dev Env

We need to edit the default HTTP Trigger function so that it returns the current time.
...
Follow the directions in this [link](https://docs.microsoft.com/en-us/azure/azure-functions/functions-develop-local) to set up and deploy your first Azure Function right in your local machine.
...
<-- insert dropdown on how to use azure functions with vscode -->
