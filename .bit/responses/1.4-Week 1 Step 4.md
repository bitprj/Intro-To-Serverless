...
**Option 1:**
Paste the *function url* directly in your browser and add the query parameters to the end of the url: `&param_name=param_value`. 

**Option 2:**
Use **Postman**! Paste the *function url* and make a GET request.
<br><br/>
</details>
