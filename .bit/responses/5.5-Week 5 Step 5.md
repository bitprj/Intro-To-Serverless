...
- [ ] ***1:*** Based on your schedule determined in "timeline.md", find the first issue you need to work on and begin your first task
- [ ] ***2:*** Commit your code in a new branch named after the component (e.g. `frontend` or `Spotify-API`)
- [ ] ***3:*** Close the issue when you have completed it
