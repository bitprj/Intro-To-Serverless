...
### ✅  Tasks:
- [ ] Run `git pull`
- [ ] ***1:*** Code an HTTP trigger function with `morse-code-converter` that takes in English as a parameter and outputs it in Morse Code.
- [ ] ***2:*** Place the function URL of your new Morse Code HTTP Trigger as a repository secret named `MORSE_ENDPOINT`.
- [ ] ***3:*** Switch to the `week1` branch.
...
### 1 Continued: Using morse-code-converter
<details>
